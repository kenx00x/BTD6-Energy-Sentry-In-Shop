...
using MelonLoader;
using System.IO;
[assembly: MelonInfo(typeof(BTD6_Energy_Sentry_In_Shop.Class1), "Energy Sentry In Shop", "1.0.0", "kenx00x")]
...
namespace BTD6_Energy_Sentry_In_Shop
{
    public class Class1 : MelonMod
    {
        ...
        {
            MelonLogger.Log("Energy Sentry In Shop mod loaded");
        ...
        public class ProfileModel_Patch
        {
            ...
            public static void Postfix(ProfileModel __instance)
            {
                ...
                {
                    MelonLogger.Log("Energy Sentry already unlocked");
                }
                else
                {
                    MelonLogger.Log("unlocking Energy Sentry");
